...
class BaseScoreComponent(ABC):
    ...
    def _assign_transformation(self):
        ...
        if transform_params:
            ...
            self.parameters.specific_parameters[self.component_specific_parameters.TRANSFORMATION] = {
    ...
    def get_transformation(self, transform_param: dict):
        return TransformationFactory().get_transformation_function(transform_param)

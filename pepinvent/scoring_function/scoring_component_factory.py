...
from pepinvent.scoring_function.scoring_components.custom.hbd import HydrogenBondDonor
from pepinvent.scoring_function.scoring_components.custom.logp import LogP

from pepinvent.scoring_function.scoring_components.custom.synthetic_accessibility import SyntheticAccessibility
...
class ScoringComponentFactory:
    def __init__(self):
        self._registry = {
            ...
            # Custom components
            ComponentNamesEnum.SyntheticAccessibility: SyntheticAccessibility,
            ComponentNamesEnum.HydrogenBondDonor: HydrogenBondDonor,
            ComponentNamesEnum.LogP: LogP,
        }
